        ...
        <div className="min-h-screen w-screen flex font-montserrat text-gray-700 mt-12">
            <motion.div initial={{opacity: 0}} whileInView={{opacity: 1}} className={'mx-auto max-w-7xl mt-12 h-full'}>
                <div className={"mt-4 mb-2"}>
                    <TitleSmallCard title={"Kullanım Koşulları"}/>
                </div>
                ...
                <div className={"mt-4 mb-2"}>
                    <TitleSmallCard title={"Kapsam ve Değişiklikler"}/>
                </div>
                ...
                <div className={"mt-4 mb-2"}>
                    <TitleSmallCard title={"Hizmet İçeriği ve Kullanım"}/>
                </div>
                ...
                <div className={"mt-4 mb-2"}>
                    <TitleSmallCard title={"Kullanıcı Yükümlülükleri"}/>
                </div>
                ...
                <div className={"mt-4 mb-2"}>
                    <TitleSmallCard title={"Fikri Mülkiyet Hakları"}/>
                </div>
                ...
                <div className={"mt-4 mb-2"}>
                    <TitleSmallCard title={"Genel Hükümler"}/>
                </div>
                <ol>
                ...
                <div className={"mt-4 mb-2"}>
                    <TitleSmallCard title={"Sorumluluk Sınırları"}/>
                </div>
                ...
                <div className={"mt-4 mb-2"}>
                    <TitleSmallCard title={"Uyuşmazlık Çözümü"}/>
                </div>
                ...
                <div className={"mt-4 mb-2"}>
                    <TitleSmallCard title={"Son Hükümler"}/>
                </div>
