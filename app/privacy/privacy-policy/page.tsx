    ...
    return (
        <div className="min-h-screen w-screen flex font-montserrat text-gray-700 mt-12">
            <motion.div initial={{opacity: 0}} whileInView={{opacity: 1}} className={'mx-auto max-w-7xl mt-12 h-full'}>
                ...
                <div className={"mt-4 mb-2"}>
                    <TitleCardSmall title={"Veri Sorumlusu"}/>
                </div>
                ...
                <div className={"mt-4 mb-2"}>
                    <TitleCardSmall title={"Toplanan Kişisel Veriler"}/>
                </div>
                ...
                <div className={"mt-4 mb-2"}>
                    <TitleCardSmall title={"Kullanılan Servisler"}/>
                </div>
                ...
                <div className={"mt-4 mb-2"}>
                    <TitleCardSmall title={"Verilerin İşlenme Amaçları"}/>
                </div>
                ...
                <div className={"mt-4 mb-2"}>
                    <TitleCardSmall title={"Çerez Kullanımı"}/>
                </div>
                ...
                <div className={"mt-4 mb-2"}>
                    <TitleCardSmall title={"Yasal Haklarınız"}/>
                </div>
                ...
                <div className={"mt-4 mb-2"}>
                    <TitleCardSmall title={"Onay ve Yükümlülük"}/>
                </div>
